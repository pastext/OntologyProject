...
class JSONNode(json.JSONEncoder):
    def default(self, o):
        return {'right': o.right, 'left': o.left}
    
    @staticmethod
    def to_json(o):
        # if isinstance(o, Node) or isinstance(o, Root):
        #     return json.dumps({
        #         'right' : o.right,
        #         'left' : o.left
        #     },
        #         indent = 3, cls = JSONNode)
        if isinstance(o, Root):
            return json.dumps({
                'elements' : o.elements.right,
                'classes' : o.classes.right
                # 'elements' : JSONNode.to_json(o.elements),
                # 'classes' : JSONNode.to_json(o.classes)
            },
                indent = 10, cls = JSONNode)#default = JSONNode.default(o))#

    @staticmethod
    def from_json(o):
        o = json.loads(o)
        try:
            return(Node(left = o['left'], right = o['right']))
        except:
            print('can\'t take data')
    ...
    def menu(self):
            ...
            while x != 0:
                ...
                if x == 1:
                    ...
                    print(JSONNode.to_json(self))
                    #print(json.dumps(self, indent=3, cls = TestEncoder))
